...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashObjectKeys = __webpack_require__(5);

	var _lodashObjectKeys2 = _interopRequireDefault(_lodashObjectKeys);

	var _lodashCollectionSortBy = __webpack_require__(20);

	var _lodashCollectionSortBy2 = _interopRequireDefault(_lodashCollectionSortBy);

	var _lodashObjectForIn = __webpack_require__(56);

	var _lodashObjectForIn2 = _interopRequireDefault(_lodashObjectForIn);

	var _lodashLangIsEqual = __webpack_require__(58);
	...
	var ApiBro = (function () {
	    ...
	    _createClass(ApiBro, [{
	        ...
	        key: 'parseServicePath',
	        value: function parseServicePath(path, type) {
	            var data = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];

	            return type === 'get' ? data ? path + '?' + _queryString2['default'].stringify(data) : path : path;
	        }
	    }, {
	        key: 'service',
	        value: function service(type, path) {
	            var _this = this;
	            ...
	            return new Promise(function (resolve, reject) {
	                ...
	                fetch(path, request).then(function (res) {
	        ...
	        key: 'multiRequestService',
	        value: function multiRequestService(type, req) {
	            var _this2 = this;
	            ...
	            var multiReqRes = {};
	            return new Promise(function (resolve, reject) {
	                (0, _lodashObjectForIn2['default'])(req, function (value, key) {
	                    fetch(_this2.fullPath(value)).then(function (res) {
	                        return res.status == 200 ? res.json() : null;
	                    }).then(function (res) {
	                        multiReqRes[key] = res;
	                        reqKeys = (0, _lodashCollectionSortBy2['default'])((0, _lodashObjectKeys2['default'])(req));
	                        resKeys = (0, _lodashCollectionSortBy2['default'])((0, _lodashObjectKeys2['default'])(multiReqRes));
	                        if (!resKeys.length) return;
	                        if ((0, _lodashLangIsEqual2['default'])(reqKeys, resKeys)) resolve(multiReqRes);
	                    })['catch'](function (err) {
	                        return reject(err);
	                    });
	                });
	        ...
	        value: function get() {
	            ...
	            if (typeof path === 'string') return this.service('get', this.fullPath(path), data);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseCallback = __webpack_require__(21),
	    baseMap = __webpack_require__(46),
	    baseSortBy = __webpack_require__(52),
	    compareAscending = __webpack_require__(53),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var equalArrays = __webpack_require__(26),
	    equalByTag = __webpack_require__(28),
	    equalObjects = __webpack_require__(29),
	    isArray = __webpack_require__(17),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseCompareAscending = __webpack_require__(54);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseFor = __webpack_require__(49),
	    createForIn = __webpack_require__(57);
